...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("igmDescription")]
    public sealed class MayaGenerated_IgmDescriptionNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (igmDescription)")]
