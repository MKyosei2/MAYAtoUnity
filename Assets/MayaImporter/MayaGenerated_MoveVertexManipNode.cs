...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("moveVertexManip")]
    public sealed class MayaGenerated_MoveVertexManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (moveVertexManip)")]
