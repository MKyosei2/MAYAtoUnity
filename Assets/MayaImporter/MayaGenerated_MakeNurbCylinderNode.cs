...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("makeNurbCylinder")]
    public sealed class MayaGenerated_MakeNurbCylinderNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (makeNurbCylinder)")]
