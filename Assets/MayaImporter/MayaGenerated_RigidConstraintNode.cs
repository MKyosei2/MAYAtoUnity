...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("rigidConstraint")]
    public sealed class MayaGenerated_RigidConstraintNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (rigidConstraint)")]
