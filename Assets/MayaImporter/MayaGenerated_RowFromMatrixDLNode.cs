...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("rowFromMatrixDL")]
    public sealed class MayaGenerated_RowFromMatrixDLNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (rowFromMatrixDL)")]
