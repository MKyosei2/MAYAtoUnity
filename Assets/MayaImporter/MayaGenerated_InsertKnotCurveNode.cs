...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("insertKnotCurve")]
    public sealed class MayaGenerated_InsertKnotCurveNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (insertKnotCurve)")]
