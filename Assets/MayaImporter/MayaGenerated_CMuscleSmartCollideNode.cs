...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("cMuscleSmartCollide")]
    public sealed class MayaGenerated_CMuscleSmartCollideNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (cMuscleSmartCollide)")]
