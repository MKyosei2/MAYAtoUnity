...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("squareSrfManip")]
    public sealed class MayaGenerated_SquareSrfManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (squareSrfManip)")]
