...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyContourProj")]
    public sealed class MayaGenerated_PolyContourProjNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyContourProj)")]
