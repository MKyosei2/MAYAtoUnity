...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("materialTemplate")]
    public sealed class MayaGenerated_MaterialTemplateNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (materialTemplate)")]
