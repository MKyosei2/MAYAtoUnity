...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("subdCleanTopology")]
    public sealed class MayaGenerated_SubdCleanTopologyNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (subdCleanTopology)")]
