...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("rotateLimitsManip")]
    public sealed class MayaGenerated_RotateLimitsManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (rotateLimitsManip)")]
