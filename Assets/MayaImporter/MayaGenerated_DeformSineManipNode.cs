...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("deformSineManip")]
    public sealed class MayaGenerated_DeformSineManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (deformSineManip)")]
