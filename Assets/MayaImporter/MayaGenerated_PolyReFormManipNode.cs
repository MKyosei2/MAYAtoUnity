...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyReFormManip")]
    public sealed class MayaGenerated_PolyReFormManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyReFormManip)")]
