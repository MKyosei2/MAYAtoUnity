...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("MASH_Constraint")]
    public sealed class MayaGenerated_MASHConstraintNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (MASH_Constraint)")]
