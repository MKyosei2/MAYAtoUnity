...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("manipContainer")]
    public sealed class MayaGenerated_ManipContainerNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (manipContainer)")]
