...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("deformBendManip")]
    public sealed class MayaGenerated_DeformBendManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (deformBendManip)")]
