...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("floatCondition")]
    public sealed class MayaGenerated_FloatConditionNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (floatCondition)")]
