...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("projectTangentManip")]
    public sealed class MayaGenerated_ProjectTangentManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (projectTangentManip)")]
