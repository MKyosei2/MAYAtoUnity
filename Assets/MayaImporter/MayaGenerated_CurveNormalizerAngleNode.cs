...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("curveNormalizerAngle")]
    public sealed class MayaGenerated_CurveNormalizerAngleNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (curveNormalizerAngle)")]
