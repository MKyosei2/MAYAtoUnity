...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyEditEdgeFlow")]
    public sealed class MayaGenerated_PolyEditEdgeFlowNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyEditEdgeFlow)")]
