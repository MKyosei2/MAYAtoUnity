...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("MASH_BlendDeformer")]
    public sealed class MayaGenerated_MASHBlendDeformerNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (MASH_BlendDeformer)")]
