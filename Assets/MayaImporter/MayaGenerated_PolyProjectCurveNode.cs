...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyProjectCurve")]
    public sealed class MayaGenerated_PolyProjectCurveNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyProjectCurve)")]
