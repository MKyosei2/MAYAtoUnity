...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("texSmoothManip")]
    public sealed class MayaGenerated_TexSmoothManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (texSmoothManip)")]
