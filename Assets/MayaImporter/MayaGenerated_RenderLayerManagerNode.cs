...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("renderLayerManager")]
    public sealed class MayaGenerated_RenderLayerManagerNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (renderLayerManager)")]
