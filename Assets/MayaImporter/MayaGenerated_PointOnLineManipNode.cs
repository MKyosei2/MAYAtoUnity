...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("pointOnLineManip")]
    public sealed class MayaGenerated_PointOnLineManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (pointOnLineManip)")]
