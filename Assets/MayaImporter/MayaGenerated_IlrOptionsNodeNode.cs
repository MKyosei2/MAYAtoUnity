...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("ilrOptionsNode")]
    public sealed class MayaGenerated_IlrOptionsNodeNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (ilrOptionsNode)")]
