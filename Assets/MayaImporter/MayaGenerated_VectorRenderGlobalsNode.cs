...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("vectorRenderGlobals")]
    public sealed class MayaGenerated_VectorRenderGlobalsNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (vectorRenderGlobals)")]
