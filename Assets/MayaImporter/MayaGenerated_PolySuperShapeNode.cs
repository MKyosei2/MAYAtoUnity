...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polySuperShape")]
    public sealed class MayaGenerated_PolySuperShapeNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polySuperShape)")]
