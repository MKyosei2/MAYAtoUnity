...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyCreateToolManip")]
    public sealed class MayaGenerated_PolyCreateToolManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyCreateToolManip)")]
