...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("roundRadiusManip")]
    public sealed class MayaGenerated_RoundRadiusManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (roundRadiusManip)")]
