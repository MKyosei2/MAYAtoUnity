...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("HIKControlSetNode")]
    public sealed class MayaGenerated_HIKControlSetNodeNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (HIKControlSetNode)")]
