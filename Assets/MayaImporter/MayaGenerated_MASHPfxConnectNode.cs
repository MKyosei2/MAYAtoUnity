...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("MASH_PfxConnect")]
    public sealed class MayaGenerated_MASHPfxConnectNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (MASH_PfxConnect)")]
