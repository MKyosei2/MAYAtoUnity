...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("leastSquaresModifier")]
    public sealed class MayaGenerated_LeastSquaresModifierNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (leastSquaresModifier)")]
