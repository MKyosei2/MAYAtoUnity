...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("angleBetweenDL")]
    public sealed class MayaGenerated_AngleBetweenDLNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (angleBetweenDL)")]
