...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("xgmConnectivity")]
    public sealed class MayaGenerated_XgmConnectivityNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (xgmConnectivity)")]
