...
// NodeType: nodeGraphEditorBookmarks
...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("nodeGraphEditorBookmarks")]
    public sealed class MayaGenerated_NodeGraphEditorBookmarksNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (nodeGraphEditorBookmarks)")]
