...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("positionMarker")]
    public sealed class MayaGenerated_PositionMarkerNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (positionMarker)")]
