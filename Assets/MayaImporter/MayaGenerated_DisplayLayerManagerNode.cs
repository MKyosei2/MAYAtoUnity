...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("displayLayerManager")]
    public sealed class MayaGenerated_DisplayLayerManagerNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (displayLayerManager)")]
