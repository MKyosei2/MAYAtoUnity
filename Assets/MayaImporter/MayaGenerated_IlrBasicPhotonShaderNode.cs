...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("ilrBasicPhotonShader")]
    public sealed class MayaGenerated_IlrBasicPhotonShaderNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (ilrBasicPhotonShader)")]
