...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("offsetCurveManip")]
    public sealed class MayaGenerated_OffsetCurveManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (offsetCurveManip)")]
