...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("ilrSurfaceThickness")]
    public sealed class MayaGenerated_IlrSurfaceThicknessNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (ilrSurfaceThickness)")]
