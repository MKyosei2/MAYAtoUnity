...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("freePointTriadManip")]
    public sealed class MayaGenerated_FreePointTriadManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (freePointTriadManip)")]
