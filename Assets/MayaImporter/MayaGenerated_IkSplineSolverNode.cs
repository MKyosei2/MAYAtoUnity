...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("ikSplineSolver")]
    public sealed class MayaGenerated_IkSplineSolverNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (ikSplineSolver)")]
