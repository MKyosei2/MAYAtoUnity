...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polySmoothProxy")]
    public sealed class MayaGenerated_PolySmoothProxyNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polySmoothProxy)")]
