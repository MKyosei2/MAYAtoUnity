...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("defaultShaderList")]
    public sealed class MayaGenerated_DefaultShaderListNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (defaultShaderList)")]
