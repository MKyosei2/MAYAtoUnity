...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("xgmHairMapping")]
    public sealed class MayaGenerated_XgmHairMappingNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (xgmHairMapping)")]
