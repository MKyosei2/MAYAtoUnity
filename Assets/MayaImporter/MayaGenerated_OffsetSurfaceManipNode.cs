...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("offsetSurfaceManip")]
    public sealed class MayaGenerated_OffsetSurfaceManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (offsetSurfaceManip)")]
