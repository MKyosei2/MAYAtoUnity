...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("nodeGraphEditorInfo")]
    public sealed class MayaGenerated_NodeGraphEditorInfoNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (nodeGraphEditorInfo)")]
