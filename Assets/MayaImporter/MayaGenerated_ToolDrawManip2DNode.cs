...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("toolDrawManip2D")]
    public sealed class MayaGenerated_ToolDrawManip2DNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (toolDrawManip2D)")]
