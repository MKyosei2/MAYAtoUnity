...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("viewColorManager")]
    public sealed class MayaGenerated_ViewColorManagerNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (viewColorManager)")]
