...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("particleIncandMapper")]
    public sealed class MayaGenerated_ParticleIncandMapperNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (particleIncandMapper)")]
