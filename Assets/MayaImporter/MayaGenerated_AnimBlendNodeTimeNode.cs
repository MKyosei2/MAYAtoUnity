...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("animBlendNodeTime")]
    public sealed class MayaGenerated_AnimBlendNodeTimeNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (animBlendNodeTime)")]
