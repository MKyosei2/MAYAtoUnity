...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polySmoothFace")]
    public sealed class MayaGenerated_PolySmoothFaceNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polySmoothFace)")]
