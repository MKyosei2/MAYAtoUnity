...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("columnFromMatrixDL")]
    public sealed class MayaGenerated_ColumnFromMatrixDLNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (columnFromMatrixDL)")]
