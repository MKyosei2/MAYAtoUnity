...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("simpleTestNode")]
    public sealed class MayaGenerated_SimpleTestNodeNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (simpleTestNode)")]
