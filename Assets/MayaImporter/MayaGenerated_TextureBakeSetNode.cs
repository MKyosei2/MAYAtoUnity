...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("textureBakeSet")]
    public sealed class MayaGenerated_TextureBakeSetNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (textureBakeSet)")]
