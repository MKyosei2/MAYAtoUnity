...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("ShaderfxShader")]
    public sealed class MayaGenerated_ShaderfxShaderNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (ShaderfxShader)")]
