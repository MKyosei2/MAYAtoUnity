...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("cMuscleDirection")]
    public sealed class MayaGenerated_CMuscleDirectionNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (cMuscleDirection)")]
