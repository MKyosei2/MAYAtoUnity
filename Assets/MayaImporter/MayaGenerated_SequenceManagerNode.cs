...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("sequenceManager")]
    public sealed class MayaGenerated_SequenceManagerNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (sequenceManager)")]
