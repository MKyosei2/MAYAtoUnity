...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("combinationShape")]
    public sealed class MayaGenerated_CombinationShapeNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (combinationShape)")]
