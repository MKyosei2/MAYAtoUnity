...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("xgmModifierGuide")]
    public sealed class MayaGenerated_XgmModifierGuideNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (xgmModifierGuide)")]
