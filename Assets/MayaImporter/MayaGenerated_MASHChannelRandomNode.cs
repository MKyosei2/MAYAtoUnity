...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("MASH_ChannelRandom")]
    public sealed class MayaGenerated_MASHChannelRandomNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (MASH_ChannelRandom)")]
