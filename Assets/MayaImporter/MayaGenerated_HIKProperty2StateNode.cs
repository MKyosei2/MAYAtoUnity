...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("HIKProperty2State")]
    public sealed class MayaGenerated_HIKProperty2StateNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (HIKProperty2State)")]
