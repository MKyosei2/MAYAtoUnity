...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("pointOnMeshInfo")]
    public sealed class MayaGenerated_PointOnMeshInfoNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (pointOnMeshInfo)")]
