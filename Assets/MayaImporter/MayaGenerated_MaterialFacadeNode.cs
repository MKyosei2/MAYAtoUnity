...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("materialFacade")]
    public sealed class MayaGenerated_MaterialFacadeNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (materialFacade)")]
