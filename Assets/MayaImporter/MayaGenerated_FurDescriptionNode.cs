...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("FurDescription")]
    public sealed class MayaGenerated_FurDescriptionNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (FurDescription)")]
