...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("shapeEditorManager")]
    public sealed class MayaGenerated_ShapeEditorManagerNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (shapeEditorManager)")]
