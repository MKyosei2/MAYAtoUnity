...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyMergeVertsManip")]
    public sealed class MayaGenerated_PolyMergeVertsManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyMergeVertsManip)")]
