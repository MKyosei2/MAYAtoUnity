...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("xgmModifierCut")]
    public sealed class MayaGenerated_XgmModifierCutNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (xgmModifierCut)")]
