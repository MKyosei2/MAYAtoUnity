...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("MASH_InitialState")]
    public sealed class MayaGenerated_MASHInitialStateNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (MASH_InitialState)")]
