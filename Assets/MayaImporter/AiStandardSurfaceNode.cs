...
namespace MayaImporter.Shading
{
    ...
    [MayaNodeType("aiStandardSurface")]
    public sealed class AiStandardSurfaceNode : MayaNodeComponentBase
    {
        public override void ApplyToUnity(MayaImportOptions options, MayaImportLog log)
        {
            ...
            meta.mayaShaderType = "aiStandardSurface";
            ...
            // opacity is color3: 1=opaque
            meta.opacity = ReadOpacityColorOrFloat(new[] { "opacity", ".opacity", "op", ".op" }, meta.opacity);

            // ---- Texture source (direct incoming)
            ...
            // ---- Normalize: resolve complex chains -> first upstream "file"
            ...
            log.Info($"[aiStandardSurface] baseColor={meta.baseColor} base={meta.baseWeight} metal={meta.metallic} rough={meta.roughness} op={meta.opacity} | tex(nrm={meta.normalTextureNode})");
        }
