...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("relUniqueOverride")]
    public sealed class MayaGenerated_RelUniqueOverrideNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (relUniqueOverride)")]
