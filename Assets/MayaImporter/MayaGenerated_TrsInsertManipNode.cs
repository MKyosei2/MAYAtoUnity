...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("trsInsertManip")]
    public sealed class MayaGenerated_TrsInsertManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (trsInsertManip)")]
