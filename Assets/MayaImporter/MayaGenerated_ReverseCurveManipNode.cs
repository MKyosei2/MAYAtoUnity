...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("reverseCurveManip")]
    public sealed class MayaGenerated_ReverseCurveManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (reverseCurveManip)")]
