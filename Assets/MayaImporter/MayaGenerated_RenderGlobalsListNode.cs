...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("renderGlobalsList")]
    public sealed class MayaGenerated_RenderGlobalsListNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (renderGlobalsList)")]
