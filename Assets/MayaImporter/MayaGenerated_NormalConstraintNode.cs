...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("normalConstraint")]
    public sealed class MayaGenerated_NormalConstraintNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (normalConstraint)")]
