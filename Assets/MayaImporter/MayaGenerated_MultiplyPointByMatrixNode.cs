...
// NodeType: multiplyPointByMatrix
...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("multiplyPointByMatrix")]
    public sealed class MayaGenerated_MultiplyPointByMatrixNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (multiplyPointByMatrix)")]
