...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("primitiveFalloff")]
    public sealed class MayaGenerated_PrimitiveFalloffNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (primitiveFalloff)")]
