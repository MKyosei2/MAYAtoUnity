...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyCircularize")]
    public sealed class MayaGenerated_PolyCircularizeNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyCircularize)")]
