...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("floatComposite")]
    public sealed class MayaGenerated_FloatCompositeNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (floatComposite)")]
