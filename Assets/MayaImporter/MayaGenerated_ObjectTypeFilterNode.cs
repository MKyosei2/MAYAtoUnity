...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("objectTypeFilter")]
    public sealed class MayaGenerated_ObjectTypeFilterNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (objectTypeFilter)")]
