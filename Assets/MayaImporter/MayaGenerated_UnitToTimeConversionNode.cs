...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("unitToTimeConversion")]
    public sealed class MayaGenerated_UnitToTimeConversionNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (unitToTimeConversion)")]
