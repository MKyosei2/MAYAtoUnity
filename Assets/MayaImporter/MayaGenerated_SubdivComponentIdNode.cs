...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("subdivComponentId")]
    public sealed class MayaGenerated_SubdivComponentIdNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (subdivComponentId)")]
