...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("xgmModifierSculpt")]
    public sealed class MayaGenerated_XgmModifierSculptNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (xgmModifierSculpt)")]
