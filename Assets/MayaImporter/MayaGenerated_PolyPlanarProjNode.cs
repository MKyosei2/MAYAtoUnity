...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyPlanarProj")]
    public sealed class MayaGenerated_PolyPlanarProjNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyPlanarProj)")]
