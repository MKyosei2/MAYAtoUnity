...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("surfaceVarGroup")]
    public sealed class MayaGenerated_SurfaceVarGroupNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (surfaceVarGroup)")]
