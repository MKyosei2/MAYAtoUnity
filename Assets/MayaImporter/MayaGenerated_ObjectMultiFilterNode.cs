...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("objectMultiFilter")]
    public sealed class MayaGenerated_ObjectMultiFilterNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (objectMultiFilter)")]
