...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("deformTwistManip")]
    public sealed class MayaGenerated_DeformTwistManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (deformTwistManip)")]
