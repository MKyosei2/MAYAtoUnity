...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("xgmPointsManip")]
    public sealed class MayaGenerated_XgmPointsManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (xgmPointsManip)")]
