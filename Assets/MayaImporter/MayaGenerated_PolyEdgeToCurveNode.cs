...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyEdgeToCurve")]
    public sealed class MayaGenerated_PolyEdgeToCurveNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyEdgeToCurve)")]
