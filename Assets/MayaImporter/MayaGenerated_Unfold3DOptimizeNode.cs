...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("Unfold3DOptimize")]
    public sealed class MayaGenerated_Unfold3DOptimizeNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (Unfold3DOptimize)")]
