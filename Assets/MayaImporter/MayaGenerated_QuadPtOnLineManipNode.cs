...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("quadPtOnLineManip")]
    public sealed class MayaGenerated_QuadPtOnLineManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (quadPtOnLineManip)")]
