...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("weightGeometryFilter")]
    public sealed class MayaGenerated_WeightGeometryFilterNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (weightGeometryFilter)")]
