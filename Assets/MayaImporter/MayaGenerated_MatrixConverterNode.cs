...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("matrixConverter")]
    public sealed class MayaGenerated_MatrixConverterNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (matrixConverter)")]
