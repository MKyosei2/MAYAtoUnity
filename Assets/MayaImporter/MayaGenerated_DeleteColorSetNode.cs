...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("deleteColorSet")]
    public sealed class MayaGenerated_DeleteColorSetNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (deleteColorSet)")]
