...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyMoveVertexManip")]
    public sealed class MayaGenerated_PolyMoveVertexManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyMoveVertexManip)")]
