...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("motionPathManip")]
    public sealed class MayaGenerated_MotionPathManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (motionPathManip)")]
