...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("fluidSliceManip")]
    public sealed class MayaGenerated_FluidSliceManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (fluidSliceManip)")]
