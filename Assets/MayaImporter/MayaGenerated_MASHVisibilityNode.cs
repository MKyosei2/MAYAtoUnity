...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("MASH_Visibility")]
    public sealed class MayaGenerated_MASHVisibilityNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (MASH_Visibility)")]
