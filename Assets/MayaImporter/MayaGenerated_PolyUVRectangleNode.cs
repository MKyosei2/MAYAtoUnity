...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyUVRectangle")]
    public sealed class MayaGenerated_PolyUVRectangleNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyUVRectangle)")]
