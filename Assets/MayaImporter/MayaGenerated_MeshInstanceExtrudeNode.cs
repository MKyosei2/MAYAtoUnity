...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("meshInstanceExtrude")]
    public sealed class MayaGenerated_MeshInstanceExtrudeNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (meshInstanceExtrude)")]
