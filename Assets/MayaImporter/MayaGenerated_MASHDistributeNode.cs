...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("MASH_Distribute")]
    public sealed class MayaGenerated_MASHDistributeNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (MASH_Distribute)")]
