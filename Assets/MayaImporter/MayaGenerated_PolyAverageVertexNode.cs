...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyAverageVertex")]
    public sealed class MayaGenerated_PolyAverageVertexNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyAverageVertex)")]
