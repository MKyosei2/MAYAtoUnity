...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("distanceBetweenDL")]
    public sealed class MayaGenerated_DistanceBetweenDLNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (distanceBetweenDL)")]
