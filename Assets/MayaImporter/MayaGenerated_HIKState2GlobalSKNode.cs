...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("HIKState2GlobalSK")]
    public sealed class MayaGenerated_HIKState2GlobalSKNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (HIKState2GlobalSK)")]
