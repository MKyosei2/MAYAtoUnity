...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("xgmCurveToSpline")]
    public sealed class MayaGenerated_XgmCurveToSplineNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (xgmCurveToSpline)")]
