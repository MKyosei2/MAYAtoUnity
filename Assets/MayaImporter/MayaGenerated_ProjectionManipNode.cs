...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("projectionManip")]
    public sealed class MayaGenerated_ProjectionManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (projectionManip)")]
