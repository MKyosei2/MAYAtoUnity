...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("ilrHwBakeVisualizer")]
    public sealed class MayaGenerated_IlrHwBakeVisualizerNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (ilrHwBakeVisualizer)")]
