...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("motionTrailShape")]
    public sealed class MayaGenerated_MotionTrailShapeNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (motionTrailShape)")]
