...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("hyperGraphInfo")]
    public sealed class MayaGenerated_HyperGraphInfoNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (hyperGraphInfo)")]
