...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("controlCollector")]
    public sealed class MayaGenerated_ControlCollectorNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (controlCollector)")]
