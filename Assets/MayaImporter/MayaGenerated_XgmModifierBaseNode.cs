...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("xgmModifierBase")]
    public sealed class MayaGenerated_XgmModifierBaseNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (xgmModifierBase)")]
