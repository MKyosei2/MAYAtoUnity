...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("nearestPointOnMesh")]
    public sealed class MayaGenerated_NearestPointOnMeshNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (nearestPointOnMesh)")]
