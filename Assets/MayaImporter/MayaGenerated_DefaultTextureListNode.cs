...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("defaultTextureList")]
    public sealed class MayaGenerated_DefaultTextureListNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (defaultTextureList)")]
