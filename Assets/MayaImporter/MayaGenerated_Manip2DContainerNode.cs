...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("manip2DContainer")]
    public sealed class MayaGenerated_Manip2DContainerNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (manip2DContainer)")]
