...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("objectNameFilter")]
    public sealed class MayaGenerated_ObjectNameFilterNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (objectNameFilter)")]
