...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("makeNurbCircle")]
    public sealed class MayaGenerated_MakeNurbCircleNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (makeNurbCircle)")]
