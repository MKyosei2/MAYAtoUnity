...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("projectionMultiManip")]
    public sealed class MayaGenerated_ProjectionMultiManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (projectionMultiManip)")]
