...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("sweepMeshCreator")]
    public sealed class MayaGenerated_SweepMeshCreatorNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (sweepMeshCreator)")]
