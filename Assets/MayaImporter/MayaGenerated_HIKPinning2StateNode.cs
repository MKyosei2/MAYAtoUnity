...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("HIKPinning2State")]
    public sealed class MayaGenerated_HIKPinning2StateNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (HIKPinning2State)")]
