...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("ufeProxyCameraShape")]
    public sealed class MayaGenerated_UfeProxyCameraShapeNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (ufeProxyCameraShape)")]
