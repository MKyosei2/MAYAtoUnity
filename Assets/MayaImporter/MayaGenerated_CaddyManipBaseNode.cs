...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("caddyManipBase")]
    public sealed class MayaGenerated_CaddyManipBaseNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (caddyManipBase)")]
