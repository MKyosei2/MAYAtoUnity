...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("orientationMarker")]
    public sealed class MayaGenerated_OrientationMarkerNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (orientationMarker)")]
