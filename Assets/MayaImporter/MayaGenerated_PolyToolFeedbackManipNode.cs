...
// NodeType: polyToolFeedbackManip
...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyToolFeedbackManip")]
    public sealed class MayaGenerated_PolyToolFeedbackManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyToolFeedbackManip)")]
