...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("simpleVolumeShader")]
    public sealed class MayaGenerated_SimpleVolumeShaderNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (simpleVolumeShader)")]
