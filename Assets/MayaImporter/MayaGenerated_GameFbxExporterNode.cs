...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("gameFbxExporter")]
    public sealed class MayaGenerated_GameFbxExporterNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (gameFbxExporter)")]
