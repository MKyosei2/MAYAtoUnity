...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("renderedImageSource")]
    public sealed class MayaGenerated_RenderedImageSourceNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (renderedImageSource)")]
