...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("roundRadiusCrvManip")]
    public sealed class MayaGenerated_RoundRadiusCrvManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (roundRadiusCrvManip)")]
