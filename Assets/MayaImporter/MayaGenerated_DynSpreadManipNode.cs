...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("dynSpreadManip")]
    public sealed class MayaGenerated_DynSpreadManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (dynSpreadManip)")]
