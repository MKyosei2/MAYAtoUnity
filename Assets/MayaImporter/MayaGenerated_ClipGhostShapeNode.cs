...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("clipGhostShape")]
    public sealed class MayaGenerated_ClipGhostShapeNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (clipGhostShape)")]
