...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("pointOnSurfManip")]
    public sealed class MayaGenerated_PointOnSurfManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (pointOnSurfManip)")]
