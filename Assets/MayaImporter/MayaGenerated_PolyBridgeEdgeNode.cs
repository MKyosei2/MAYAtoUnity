...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyBridgeEdge")]
    public sealed class MayaGenerated_PolyBridgeEdgeNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyBridgeEdge)")]
