...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("hierarchyTestNode3")]
    public sealed class MayaGenerated_HierarchyTestNode3Node : MayaPhaseCNodeBase
    {
        [Header("Decoded (hierarchyTestNode3)")]
