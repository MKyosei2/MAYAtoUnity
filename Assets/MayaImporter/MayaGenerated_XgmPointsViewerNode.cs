...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("xgmPointsViewer")]
    public sealed class MayaGenerated_XgmPointsViewerNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (xgmPointsViewer)")]
