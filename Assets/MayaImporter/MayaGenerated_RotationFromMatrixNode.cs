...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("rotationFromMatrix")]
    public sealed class MayaGenerated_RotationFromMatrixNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (rotationFromMatrix)")]
