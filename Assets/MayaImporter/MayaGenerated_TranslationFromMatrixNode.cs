...
// NodeType: translationFromMatrix
...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("translationFromMatrix")]
    public sealed class MayaGenerated_TranslationFromMatrixNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (translationFromMatrix)")]
