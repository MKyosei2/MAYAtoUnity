...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("trackInfoManager")]
    public sealed class MayaGenerated_TrackInfoManagerNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (trackInfoManager)")]
