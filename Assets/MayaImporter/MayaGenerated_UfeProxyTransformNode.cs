...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("ufeProxyTransform")]
    public sealed class MayaGenerated_UfeProxyTransformNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (ufeProxyTransform)")]
