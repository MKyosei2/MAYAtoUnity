...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("stereoRigFrustum")]
    public sealed class MayaGenerated_StereoRigFrustumNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (stereoRigFrustum)")]
