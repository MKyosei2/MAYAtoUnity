...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("ilrUIOptionsNode")]
    public sealed class MayaGenerated_IlrUIOptionsNodeNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (ilrUIOptionsNode)")]
