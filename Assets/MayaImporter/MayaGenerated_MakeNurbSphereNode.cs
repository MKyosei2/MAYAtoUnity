...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("makeNurbSphere")]
    public sealed class MayaGenerated_MakeNurbSphereNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (makeNurbSphere)")]
