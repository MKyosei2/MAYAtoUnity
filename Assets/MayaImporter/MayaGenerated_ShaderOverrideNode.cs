...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("shaderOverride")]
    public sealed class MayaGenerated_ShaderOverrideNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (shaderOverride)")]
