...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("xgmSphereGuide")]
    public sealed class MayaGenerated_XgmSphereGuideNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (xgmSphereGuide)")]
