...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("turbulenceManip")]
    public sealed class MayaGenerated_TurbulenceManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (turbulenceManip)")]
