...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("geometryOnLineManip")]
    public sealed class MayaGenerated_GeometryOnLineManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (geometryOnLineManip)")]
