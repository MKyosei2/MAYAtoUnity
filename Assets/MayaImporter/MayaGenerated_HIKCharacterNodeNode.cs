...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("HIKCharacterNode")]
    public sealed class MayaGenerated_HIKCharacterNodeNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (HIKCharacterNode)")]
