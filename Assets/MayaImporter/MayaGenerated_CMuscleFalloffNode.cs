...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("cMuscleFalloff")]
    public sealed class MayaGenerated_CMuscleFalloffNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (cMuscleFalloff)")]
