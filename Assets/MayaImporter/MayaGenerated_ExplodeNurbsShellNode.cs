...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("explodeNurbsShell")]
    public sealed class MayaGenerated_ExplodeNurbsShellNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (explodeNurbsShell)")]
