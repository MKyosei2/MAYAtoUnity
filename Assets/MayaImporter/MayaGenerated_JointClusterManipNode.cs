...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("jointClusterManip")]
    public sealed class MayaGenerated_JointClusterManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (jointClusterManip)")]
