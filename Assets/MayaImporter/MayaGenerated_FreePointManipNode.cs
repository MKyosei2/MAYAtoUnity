...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("freePointManip")]
    public sealed class MayaGenerated_FreePointManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (freePointManip)")]
