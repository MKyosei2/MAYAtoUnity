...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("scaleFromMatrix")]
    public sealed class MayaGenerated_ScaleFromMatrixNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (scaleFromMatrix)")]
