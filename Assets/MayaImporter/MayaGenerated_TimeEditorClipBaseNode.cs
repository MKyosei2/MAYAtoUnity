...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("timeEditorClipBase")]
    public sealed class MayaGenerated_TimeEditorClipBaseNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (timeEditorClipBase)")]
