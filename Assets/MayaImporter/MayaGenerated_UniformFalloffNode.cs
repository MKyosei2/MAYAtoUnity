...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("uniformFalloff")]
    public sealed class MayaGenerated_UniformFalloffNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (uniformFalloff)")]
