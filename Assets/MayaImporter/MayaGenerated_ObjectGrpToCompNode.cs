...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("objectGrpToComp")]
    public sealed class MayaGenerated_ObjectGrpToCompNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (objectGrpToComp)")]
