...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("spotCylinderManip")]
    public sealed class MayaGenerated_SpotCylinderManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (spotCylinderManip)")]
