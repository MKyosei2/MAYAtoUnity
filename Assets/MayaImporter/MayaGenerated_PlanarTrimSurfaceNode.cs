...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("planarTrimSurface")]
    public sealed class MayaGenerated_PlanarTrimSurfaceNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (planarTrimSurface)")]
