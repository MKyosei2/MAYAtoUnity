...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyMapSewMove")]
    public sealed class MayaGenerated_PolyMapSewMoveNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyMapSewMove)")]
