...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyCaddyManip")]
    public sealed class MayaGenerated_PolyCaddyManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyCaddyManip)")]
