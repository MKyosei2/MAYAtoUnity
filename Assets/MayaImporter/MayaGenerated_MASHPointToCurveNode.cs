...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("MASH_PointToCurve")]
    public sealed class MayaGenerated_MASHPointToCurveNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (MASH_PointToCurve)")]
