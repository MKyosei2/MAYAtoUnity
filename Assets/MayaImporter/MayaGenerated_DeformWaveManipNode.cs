...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("deformWaveManip")]
    public sealed class MayaGenerated_DeformWaveManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (deformWaveManip)")]
