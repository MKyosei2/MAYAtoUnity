...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("projectTangent")]
    public sealed class MayaGenerated_ProjectTangentNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (projectTangent)")]
