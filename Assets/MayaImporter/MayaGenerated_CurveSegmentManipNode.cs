...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("curveSegmentManip")]
    public sealed class MayaGenerated_CurveSegmentManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (curveSegmentManip)")]
