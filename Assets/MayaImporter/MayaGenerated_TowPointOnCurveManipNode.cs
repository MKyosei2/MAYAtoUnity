...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("towPointOnCurveManip")]
    public sealed class MayaGenerated_TowPointOnCurveManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (towPointOnCurveManip)")]
