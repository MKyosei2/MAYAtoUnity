...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("symmetryConstraint")]
    public sealed class MayaGenerated_SymmetryConstraintNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (symmetryConstraint)")]
