...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("stitchSrfManip")]
    public sealed class MayaGenerated_StitchSrfManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (stitchSrfManip)")]
