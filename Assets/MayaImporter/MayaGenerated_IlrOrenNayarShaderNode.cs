...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("ilrOrenNayarShader")]
    public sealed class MayaGenerated_IlrOrenNayarShaderNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (ilrOrenNayarShader)")]
