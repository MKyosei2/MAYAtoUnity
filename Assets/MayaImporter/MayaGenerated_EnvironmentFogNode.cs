...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("environmentFog")]
    public sealed class MayaGenerated_EnvironmentFogNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (environmentFog)")]
