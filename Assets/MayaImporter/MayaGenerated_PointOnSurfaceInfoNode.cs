...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("pointOnSurfaceInfo")]
    public sealed class MayaGenerated_PointOnSurfaceInfoNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (pointOnSurfaceInfo)")]
