...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyAppendVertex")]
    public sealed class MayaGenerated_PolyAppendVertexNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyAppendVertex)")]
