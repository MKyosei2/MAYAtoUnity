...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("crossProductDL")]
    public sealed class MayaGenerated_CrossProductDLNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (crossProductDL)")]
