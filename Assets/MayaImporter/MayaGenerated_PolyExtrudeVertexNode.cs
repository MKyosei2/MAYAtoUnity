...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyExtrudeVertex")]
    public sealed class MayaGenerated_PolyExtrudeVertexNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyExtrudeVertex)")]
