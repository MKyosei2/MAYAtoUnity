...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("trimWithBoundaries")]
    public sealed class MayaGenerated_TrimWithBoundariesNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (trimWithBoundaries)")]
