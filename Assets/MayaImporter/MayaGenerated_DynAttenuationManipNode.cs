...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("dynAttenuationManip")]
    public sealed class MayaGenerated_DynAttenuationManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (dynAttenuationManip)")]
