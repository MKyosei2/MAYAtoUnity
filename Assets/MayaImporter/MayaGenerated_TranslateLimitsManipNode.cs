...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("translateLimitsManip")]
    public sealed class MayaGenerated_TranslateLimitsManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (translateLimitsManip)")]
