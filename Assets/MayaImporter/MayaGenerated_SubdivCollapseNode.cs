...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("subdivCollapse")]
    public sealed class MayaGenerated_SubdivCollapseNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (subdivCollapse)")]
