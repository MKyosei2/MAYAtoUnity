...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("objectRenderFilter")]
    public sealed class MayaGenerated_ObjectRenderFilterNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (objectRenderFilter)")]
