...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("ShaderfxGameHair")]
    public sealed class MayaGenerated_ShaderfxGameHairNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (ShaderfxGameHair)")]
