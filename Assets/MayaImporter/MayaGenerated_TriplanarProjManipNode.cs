...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("triplanarProjManip")]
    public sealed class MayaGenerated_TriplanarProjManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (triplanarProjManip)")]
