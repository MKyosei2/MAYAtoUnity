...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("ffBlendSrfObsolete")]
    public sealed class MayaGenerated_FfBlendSrfObsoleteNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (ffBlendSrfObsolete)")]
