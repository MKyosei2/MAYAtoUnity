...
// NodeType: coneAngleToHotspotConverter
...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("coneAngleToHotspotConverter")]
    public sealed class MayaGenerated_ConeAngleToHotspotConverterNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (coneAngleToHotspotConverter)")]
