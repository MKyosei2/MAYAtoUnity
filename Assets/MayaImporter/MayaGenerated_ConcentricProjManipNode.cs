...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("concentricProjManip")]
    public sealed class MayaGenerated_ConcentricProjManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (concentricProjManip)")]
