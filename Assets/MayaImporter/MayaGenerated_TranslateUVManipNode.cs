...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("translateUVManip")]
    public sealed class MayaGenerated_TranslateUVManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (translateUVManip)")]
