...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("xgmArchiveGuide")]
    public sealed class MayaGenerated_XgmArchiveGuideNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (xgmArchiveGuide)")]
