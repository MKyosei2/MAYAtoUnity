...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyAutoProjManip")]
    public sealed class MayaGenerated_PolyAutoProjManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyAutoProjManip)")]
