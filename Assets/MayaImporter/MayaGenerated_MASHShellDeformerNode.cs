...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("MASH_ShellDeformer")]
    public sealed class MayaGenerated_MASHShellDeformerNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (MASH_ShellDeformer)")]
