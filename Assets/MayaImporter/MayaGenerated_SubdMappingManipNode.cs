...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("subdMappingManip")]
    public sealed class MayaGenerated_SubdMappingManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (subdMappingManip)")]
