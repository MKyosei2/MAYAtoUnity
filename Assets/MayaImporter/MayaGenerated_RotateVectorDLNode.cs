...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("rotateVectorDL")]
    public sealed class MayaGenerated_RotateVectorDLNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (rotateVectorDL)")]
