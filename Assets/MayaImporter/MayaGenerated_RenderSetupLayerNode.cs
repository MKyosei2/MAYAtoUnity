...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("renderSetupLayer")]
    public sealed class MayaGenerated_RenderSetupLayerNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (renderSetupLayer)")]
