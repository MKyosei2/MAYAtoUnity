...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("hierarchyTestNode2")]
    public sealed class MayaGenerated_HierarchyTestNode2Node : MayaPhaseCNodeBase
    {
        [Header("Decoded (hierarchyTestNode2)")]
