...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("directionManip")]
    public sealed class MayaGenerated_DirectionManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (directionManip)")]
