...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("cMuscleDisplace")]
    public sealed class MayaGenerated_CMuscleDisplaceNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (cMuscleDisplace)")]
