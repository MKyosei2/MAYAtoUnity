...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("HIKRetargeterNode")]
    public sealed class MayaGenerated_HIKRetargeterNodeNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (HIKRetargeterNode)")]
