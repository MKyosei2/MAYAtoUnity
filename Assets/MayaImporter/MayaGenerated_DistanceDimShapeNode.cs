...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("distanceDimShape")]
    public sealed class MayaGenerated_DistanceDimShapeNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (distanceDimShape)")]
