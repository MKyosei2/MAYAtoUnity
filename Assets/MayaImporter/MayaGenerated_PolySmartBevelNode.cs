...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polySmartBevel")]
    public sealed class MayaGenerated_PolySmartBevelNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polySmartBevel)")]
