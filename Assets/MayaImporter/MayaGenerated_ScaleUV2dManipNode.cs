...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("scaleUV2dManip")]
    public sealed class MayaGenerated_ScaleUV2dManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (scaleUV2dManip)")]
