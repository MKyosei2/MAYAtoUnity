...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("stereoRigTransform")]
    public sealed class MayaGenerated_StereoRigTransformNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (stereoRigTransform)")]
