...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("HIKEffector2State")]
    public sealed class MayaGenerated_HIKEffector2StateNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (HIKEffector2State)")]
