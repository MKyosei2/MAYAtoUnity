...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("furPointOnMeshInfo")]
    public sealed class MayaGenerated_FurPointOnMeshInfoNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (furPointOnMeshInfo)")]
