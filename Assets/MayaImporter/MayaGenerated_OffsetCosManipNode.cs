...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("offsetCosManip")]
    public sealed class MayaGenerated_OffsetCosManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (offsetCosManip)")]
