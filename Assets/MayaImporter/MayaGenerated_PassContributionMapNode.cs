...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("passContributionMap")]
    public sealed class MayaGenerated_PassContributionMapNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (passContributionMap)")]
