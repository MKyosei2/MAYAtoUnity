...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("toonLineAttributes")]
    public sealed class MayaGenerated_ToonLineAttributesNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (toonLineAttributes)")]
