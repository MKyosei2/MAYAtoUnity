...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("defaultLightList")]
    public sealed class MayaGenerated_DefaultLightListNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (defaultLightList)")]
