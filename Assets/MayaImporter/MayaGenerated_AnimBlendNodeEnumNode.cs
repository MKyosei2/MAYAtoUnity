...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("animBlendNodeEnum")]
    public sealed class MayaGenerated_AnimBlendNodeEnumNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (animBlendNodeEnum)")]
