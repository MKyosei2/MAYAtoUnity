...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("rotateUV2dManip")]
    public sealed class MayaGenerated_RotateUV2dManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (rotateUV2dManip)")]
