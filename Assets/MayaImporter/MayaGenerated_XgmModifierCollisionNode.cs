...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("xgmModifierCollision")]
    public sealed class MayaGenerated_XgmModifierCollisionNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (xgmModifierCollision)")]
