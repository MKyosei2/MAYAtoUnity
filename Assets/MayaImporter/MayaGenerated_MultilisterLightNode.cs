...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("multilisterLight")]
    public sealed class MayaGenerated_MultilisterLightNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (multilisterLight)")]
