...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("quatToAxisAngle")]
    public sealed class MayaGenerated_QuatToAxisAngleNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (quatToAxisAngle)")]
