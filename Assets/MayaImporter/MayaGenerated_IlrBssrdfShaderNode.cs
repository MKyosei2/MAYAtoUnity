...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("ilrBssrdfShader")]
    public sealed class MayaGenerated_IlrBssrdfShaderNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (ilrBssrdfShader)")]
