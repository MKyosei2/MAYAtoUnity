...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("particleAgeMapper")]
    public sealed class MayaGenerated_ParticleAgeMapperNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (particleAgeMapper)")]
