...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("connectionOverride")]
    public sealed class MayaGenerated_ConnectionOverrideNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (connectionOverride)")]
