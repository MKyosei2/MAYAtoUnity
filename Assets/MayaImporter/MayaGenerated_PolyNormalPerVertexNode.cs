...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyNormalPerVertex")]
    public sealed class MayaGenerated_PolyNormalPerVertexNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyNormalPerVertex)")]
