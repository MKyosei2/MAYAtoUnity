...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyDuplicateEdge")]
    public sealed class MayaGenerated_PolyDuplicateEdgeNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyDuplicateEdge)")]
