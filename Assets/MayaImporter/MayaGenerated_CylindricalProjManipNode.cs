...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("cylindricalProjManip")]
    public sealed class MayaGenerated_CylindricalProjManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (cylindricalProjManip)")]
