...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("openPBRSurface")]
    public sealed class MayaGenerated_OpenPBRSurfaceNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (openPBRSurface)")]
