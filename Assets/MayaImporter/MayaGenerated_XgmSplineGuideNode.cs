...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("xgmSplineGuide")]
    public sealed class MayaGenerated_XgmSplineGuideNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (xgmSplineGuide)")]
