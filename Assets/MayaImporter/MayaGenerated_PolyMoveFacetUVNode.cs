...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyMoveFacetUV")]
    public sealed class MayaGenerated_PolyMoveFacetUVNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyMoveFacetUV)")]
