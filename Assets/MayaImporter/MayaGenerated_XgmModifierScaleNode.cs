...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("xgmModifierScale")]
    public sealed class MayaGenerated_XgmModifierScaleNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (xgmModifierScale)")]
