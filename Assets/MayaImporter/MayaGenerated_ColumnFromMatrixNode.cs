...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("columnFromMatrix")]
    public sealed class MayaGenerated_ColumnFromMatrixNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (columnFromMatrix)")]
