...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("transferFalloff")]
    public sealed class MayaGenerated_TransferFalloffNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (transferFalloff)")]
