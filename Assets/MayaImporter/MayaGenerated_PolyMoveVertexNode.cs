...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyMoveVertex")]
    public sealed class MayaGenerated_PolyMoveVertexNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyMoveVertex)")]
