...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("hierarchyTestNode4")]
    public sealed class MayaGenerated_HierarchyTestNode4Node : MayaPhaseCNodeBase
    {
        [Header("Decoded (hierarchyTestNode4)")]
