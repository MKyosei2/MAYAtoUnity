...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("ikSpringSolver")]
    public sealed class MayaGenerated_IkSpringSolverNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (ikSpringSolver)")]
