...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("stitchAsNurbsShell")]
    public sealed class MayaGenerated_StitchAsNurbsShellNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (stitchAsNurbsShell)")]
