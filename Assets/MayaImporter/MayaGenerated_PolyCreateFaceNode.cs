...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyCreateFace")]
    public sealed class MayaGenerated_PolyCreateFaceNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyCreateFace)")]
