...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("transUV2dManip")]
    public sealed class MayaGenerated_TransUV2dManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (transUV2dManip)")]
