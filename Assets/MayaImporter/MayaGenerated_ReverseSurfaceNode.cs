...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("reverseSurface")]
    public sealed class MayaGenerated_ReverseSurfaceNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (reverseSurface)")]
