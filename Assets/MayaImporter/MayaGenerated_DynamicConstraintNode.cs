...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("dynamicConstraint")]
    public sealed class MayaGenerated_DynamicConstraintNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (dynamicConstraint)")]
