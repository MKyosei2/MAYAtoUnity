...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("deformSquashManip")]
    public sealed class MayaGenerated_DeformSquashManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (deformSquashManip)")]
