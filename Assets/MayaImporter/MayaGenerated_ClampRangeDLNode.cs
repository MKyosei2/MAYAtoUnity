...
// NodeType: clampRangeDL (Phase C: non-empty decode)
...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("clampRangeDL")]
    public sealed class MayaGenerated_ClampRangeDLNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (clampRangeDL)")]
