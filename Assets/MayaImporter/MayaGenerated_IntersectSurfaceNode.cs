...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("intersectSurface")]
    public sealed class MayaGenerated_IntersectSurfaceNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (intersectSurface)")]
