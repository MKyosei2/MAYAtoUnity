...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("cMuscleMultiCollide")]
    public sealed class MayaGenerated_CMuscleMultiCollideNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (cMuscleMultiCollide)")]
