...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("geoConnectable")]
    public sealed class MayaGenerated_GeoConnectableNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (geoConnectable)")]
