...
// NodeType: sweepProfileConverter
...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("sweepProfileConverter")]
    public sealed class MayaGenerated_SweepProfileConverterNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (sweepProfileConverter)")]
