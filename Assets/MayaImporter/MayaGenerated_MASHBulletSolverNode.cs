...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("MASH_BulletSolver")]
    public sealed class MayaGenerated_MASHBulletSolverNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (MASH_BulletSolver)")]
