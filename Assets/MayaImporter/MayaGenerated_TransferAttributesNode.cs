...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("transferAttributes")]
    public sealed class MayaGenerated_TransferAttributesNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (transferAttributes)")]
