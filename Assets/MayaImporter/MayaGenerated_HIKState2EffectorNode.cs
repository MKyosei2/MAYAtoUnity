...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("HIKState2Effector")]
    public sealed class MayaGenerated_HIKState2EffectorNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (HIKState2Effector)")]
