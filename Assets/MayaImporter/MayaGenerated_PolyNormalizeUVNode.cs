...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyNormalizeUV")]
    public sealed class MayaGenerated_PolyNormalizeUVNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyNormalizeUV)")]
