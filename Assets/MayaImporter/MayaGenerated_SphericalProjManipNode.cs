...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("sphericalProjManip")]
    public sealed class MayaGenerated_SphericalProjManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (sphericalProjManip)")]
