...
// NodeType: HIKSkeletonGeneratorNode
...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("HIKSkeletonGeneratorNode")]
    public sealed class MayaGenerated_HIKSkeletonGeneratorNodeNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (HIKSkeletonGeneratorNode)")]
