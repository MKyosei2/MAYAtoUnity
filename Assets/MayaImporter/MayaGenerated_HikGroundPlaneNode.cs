...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("hikGroundPlane")]
    public sealed class MayaGenerated_HikGroundPlaneNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (hikGroundPlane)")]
