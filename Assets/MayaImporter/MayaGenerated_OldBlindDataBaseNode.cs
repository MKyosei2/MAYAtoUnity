...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("oldBlindDataBase")]
    public sealed class MayaGenerated_OldBlindDataBaseNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (oldBlindDataBase)")]
