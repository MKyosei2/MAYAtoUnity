...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("ilrDielectricShader")]
    public sealed class MayaGenerated_IlrDielectricShaderNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (ilrDielectricShader)")]
