...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("stereoRigCamera")]
    public sealed class MayaGenerated_StereoRigCameraNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (stereoRigCamera)")]
