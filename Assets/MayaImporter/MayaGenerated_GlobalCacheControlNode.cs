...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("globalCacheControl")]
    public sealed class MayaGenerated_GlobalCacheControlNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (globalCacheControl)")]
