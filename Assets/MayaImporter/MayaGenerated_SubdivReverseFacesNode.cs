...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("subdivReverseFaces")]
    public sealed class MayaGenerated_SubdivReverseFacesNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (subdivReverseFaces)")]
