...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("compactPlugArrayTest")]
    public sealed class MayaGenerated_CompactPlugArrayTestNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (compactPlugArrayTest)")]
