...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyExtrudeEdge")]
    public sealed class MayaGenerated_PolyExtrudeEdgeNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyExtrudeEdge)")]
