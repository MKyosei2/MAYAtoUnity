...
// NodeType: oldGeometryConstraint
...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("oldGeometryConstraint")]
    public sealed class MayaGenerated_OldGeometryConstraintNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (oldGeometryConstraint)")]
