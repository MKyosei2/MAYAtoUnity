...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("lightsCollection")]
    public sealed class MayaGenerated_LightsCollectionNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (lightsCollection)")]
