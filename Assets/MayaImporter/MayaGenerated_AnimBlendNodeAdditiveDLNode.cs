// NodeType: animBlendNodeAdditiveDL
...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("animBlendNodeAdditiveDL")]
    public sealed class MayaGenerated_AnimBlendNodeAdditiveDLNode : MayaPhaseCNodeBase
    {
        ...
        protected override void DecodePhaseC(MayaImportOptions options, MayaImportLog log)
        {
            ...
            log.Info($"[animBlendNodeAdditiveDL] '{NodeName}' enabled={enabled} out={output:0.###}");
        }
    }
}
