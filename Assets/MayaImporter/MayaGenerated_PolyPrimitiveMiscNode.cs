...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyPrimitiveMisc")]
    public sealed class MayaGenerated_PolyPrimitiveMiscNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyPrimitiveMisc)")]
