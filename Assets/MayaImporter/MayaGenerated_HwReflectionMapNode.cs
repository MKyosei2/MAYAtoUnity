...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("hwReflectionMap")]
    public sealed class MayaGenerated_HwReflectionMapNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (hwReflectionMap)")]
