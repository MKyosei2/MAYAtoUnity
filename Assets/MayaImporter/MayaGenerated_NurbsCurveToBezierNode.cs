...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("nurbsCurveToBezier")]
    public sealed class MayaGenerated_NurbsCurveToBezierNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (nurbsCurveToBezier)")]
