...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("ilrAshikhminShader")]
    public sealed class MayaGenerated_IlrAshikhminShaderNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (ilrAshikhminShader)")]
