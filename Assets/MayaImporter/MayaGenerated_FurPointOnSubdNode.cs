...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("furPointOnSubd")]
    public sealed class MayaGenerated_FurPointOnSubdNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (furPointOnSubd)")]
