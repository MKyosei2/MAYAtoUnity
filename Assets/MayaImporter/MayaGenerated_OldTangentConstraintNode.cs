...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("oldTangentConstraint")]
    public sealed class MayaGenerated_OldTangentConstraintNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (oldTangentConstraint)")]
