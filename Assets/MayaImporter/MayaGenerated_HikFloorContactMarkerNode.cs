...
// NodeType: hikFloorContactMarker
...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("hikFloorContactMarker")]
    public sealed class MayaGenerated_HikFloorContactMarkerNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (hikFloorContactMarker)")]
