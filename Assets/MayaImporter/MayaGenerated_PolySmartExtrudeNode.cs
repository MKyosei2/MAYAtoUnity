...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polySmartExtrude")]
    public sealed class MayaGenerated_PolySmartExtrudeNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polySmartExtrude)")]
