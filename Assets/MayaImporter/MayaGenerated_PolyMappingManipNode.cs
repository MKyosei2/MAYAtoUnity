...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyMappingManip")]
    public sealed class MayaGenerated_PolyMappingManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyMappingManip)")]
