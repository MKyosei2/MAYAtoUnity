...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("objectBinFilter")]
    public sealed class MayaGenerated_ObjectBinFilterNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (objectBinFilter)")]
