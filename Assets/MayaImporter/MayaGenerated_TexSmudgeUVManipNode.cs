...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("texSmudgeUVManip")]
    public sealed class MayaGenerated_TexSmudgeUVManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (texSmudgeUVManip)")]
