...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("subdAddTopology")]
    public sealed class MayaGenerated_SubdAddTopologyNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (subdAddTopology)")]
