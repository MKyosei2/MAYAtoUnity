...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("MASH_MultiCurve")]
    public sealed class MayaGenerated_MASHMultiCurveNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (MASH_MultiCurve)")]
