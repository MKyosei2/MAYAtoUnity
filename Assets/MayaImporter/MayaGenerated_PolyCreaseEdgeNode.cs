...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyCreaseEdge")]
    public sealed class MayaGenerated_PolyCreaseEdgeNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyCreaseEdge)")]
