...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("deformFlareManip")]
    public sealed class MayaGenerated_DeformFlareManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (deformFlareManip)")]
