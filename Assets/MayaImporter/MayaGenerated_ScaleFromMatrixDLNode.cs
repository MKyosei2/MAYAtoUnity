...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("scaleFromMatrixDL")]
    public sealed class MayaGenerated_ScaleFromMatrixDLNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (scaleFromMatrixDL)")]
