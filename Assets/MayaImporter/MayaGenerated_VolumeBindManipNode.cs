...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("volumeBindManip")]
    public sealed class MayaGenerated_VolumeBindManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (volumeBindManip)")]
