...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("cMuscleSurfAttach")]
    public sealed class MayaGenerated_CMuscleSurfAttachNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (cMuscleSurfAttach)")]
