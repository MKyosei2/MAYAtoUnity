...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("makeTextCurves")]
    public sealed class MayaGenerated_MakeTextCurvesNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (makeTextCurves)")]
