...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("cMuscleRelative")]
    public sealed class MayaGenerated_CMuscleRelativeNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (cMuscleRelative)")]
