...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("pointOnSurfaceManip")]
    public sealed class MayaGenerated_PointOnSurfaceManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (pointOnSurfaceManip)")]
