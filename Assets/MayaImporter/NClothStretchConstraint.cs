...
{
    [MayaNodeType("nClothStretchConstraint")]
    [DisallowMultipleComponent]
    public sealed class NClothStretchConstraint : MayaPhaseCNodeBase
    {
        [Header("Decoded (nClothStretchConstraint)")]
        ...
        protected override void DecodePhaseC(MayaImportOptions options, MayaImportLog log)
        {
            ...
            SetNotes($"nClothStretchConstraint decoded: enabled={enabled}, stretchRes={stretchResistance}, compRes={compressionResistance}, damping={damping} (no runtime sim; attrs+connections preserved)");
        }
    }
}
