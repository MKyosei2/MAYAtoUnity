...
// NodeType: MASH_DynamicsInitialState
...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("MASH_DynamicsInitialState")]
    public sealed class MayaGenerated_MASHDynamicsInitialStateNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (MASH_DynamicsInitialState)")]
