...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyCollapseEdge")]
    public sealed class MayaGenerated_PolyCollapseEdgeNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyCollapseEdge)")]
