...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("translateManip")]
    public sealed class MayaGenerated_TranslateManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (translateManip)")]
