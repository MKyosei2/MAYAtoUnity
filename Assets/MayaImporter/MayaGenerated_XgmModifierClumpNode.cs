...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("xgmModifierClump")]
    public sealed class MayaGenerated_XgmModifierClumpNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (xgmModifierClump)")]
