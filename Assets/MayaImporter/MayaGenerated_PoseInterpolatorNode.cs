...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("poseInterpolator")]
    public sealed class MayaGenerated_PoseInterpolatorNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (poseInterpolator)")]
