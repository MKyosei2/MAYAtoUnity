...
// NodeType: ilrPhysicPhotonShader
...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("ilrPhysicPhotonShader")]
    public sealed class MayaGenerated_IlrPhysicPhotonShaderNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (ilrPhysicPhotonShader)")]
