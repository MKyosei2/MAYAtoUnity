...
// NodeType: textureDeformerHandle
...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("textureDeformerHandle")]
    public sealed class MayaGenerated_TextureDeformerHandleNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (textureDeformerHandle)")]
