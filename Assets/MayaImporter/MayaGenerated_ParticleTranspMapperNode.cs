...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("particleTranspMapper")]
    public sealed class MayaGenerated_ParticleTranspMapperNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (particleTranspMapper)")]
