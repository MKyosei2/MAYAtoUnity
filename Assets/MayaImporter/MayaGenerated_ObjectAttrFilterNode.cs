...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("objectAttrFilter")]
    public sealed class MayaGenerated_ObjectAttrFilterNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (objectAttrFilter)")]
