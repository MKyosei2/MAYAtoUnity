...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("particleColorMapper")]
    public sealed class MayaGenerated_ParticleColorMapperNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (particleColorMapper)")]
