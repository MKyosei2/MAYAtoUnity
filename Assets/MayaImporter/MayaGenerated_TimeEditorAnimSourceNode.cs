...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("timeEditorAnimSource")]
    public sealed class MayaGenerated_TimeEditorAnimSourceNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (timeEditorAnimSource)")]
