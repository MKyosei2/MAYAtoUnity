...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("subdPlanarProj")]
    public sealed class MayaGenerated_SubdPlanarProjNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (subdPlanarProj)")]
