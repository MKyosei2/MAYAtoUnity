...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("cMuscleCreator")]
    public sealed class MayaGenerated_CMuscleCreatorNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (cMuscleCreator)")]
