...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyExtrudeFace")]
    public sealed class MayaGenerated_PolyExtrudeFaceNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyExtrudeFace)")]
