...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("cMuscleStretch")]
    public sealed class MayaGenerated_CMuscleStretchNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (cMuscleStretch)")]
