...
// NodeType: polyConnectComponents
...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyConnectComponents")]
    public sealed class MayaGenerated_PolyConnectComponentsNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyConnectComponents)")]
