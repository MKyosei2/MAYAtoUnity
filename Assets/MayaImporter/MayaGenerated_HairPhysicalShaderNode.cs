...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("hairPhysicalShader")]
    public sealed class MayaGenerated_HairPhysicalShaderNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (hairPhysicalShader)")]
