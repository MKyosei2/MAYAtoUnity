...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("rebuildSurface")]
    public sealed class MayaGenerated_RebuildSurfaceNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (rebuildSurface)")]
