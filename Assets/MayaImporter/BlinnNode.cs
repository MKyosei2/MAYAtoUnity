...
namespace MayaImporter.Shading
{
    ...
    [MayaNodeType("blinn")]
    public sealed class BlinnNode : MayaNodeComponentBase
    {
        public override void ApplyToUnity(MayaImportOptions options, MayaImportLog log)
        {
            ...
            // eccentricity ~ roughness-ish (heuristic)
            meta.roughness = Mathf.Clamp01(ReadFloat(new[] { "eccentricity", ".eccentricity", "ec", ".ec" }, 0.5f));
            ...
            log.Info($"[blinn] baseColor={meta.baseColor} rough={meta.roughness} op={meta.opacity} | tex(nrm={meta.normalTextureNode})");
        }
