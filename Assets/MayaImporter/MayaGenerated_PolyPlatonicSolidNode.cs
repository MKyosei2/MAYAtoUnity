...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyPlatonicSolid")]
    public sealed class MayaGenerated_PolyPlatonicSolidNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyPlatonicSolid)")]
