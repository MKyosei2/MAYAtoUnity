...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("textButtonManip")]
    public sealed class MayaGenerated_TextButtonManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (textButtonManip)")]
