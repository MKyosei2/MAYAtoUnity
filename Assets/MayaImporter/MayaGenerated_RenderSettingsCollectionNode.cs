...
// NodeType: renderSettingsCollection
...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("renderSettingsCollection")]
    public sealed class MayaGenerated_RenderSettingsCollectionNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (renderSettingsCollection)")]
