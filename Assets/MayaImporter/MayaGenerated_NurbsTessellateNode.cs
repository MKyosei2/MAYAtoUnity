...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("nurbsTessellate")]
    public sealed class MayaGenerated_NurbsTessellateNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (nurbsTessellate)")]
