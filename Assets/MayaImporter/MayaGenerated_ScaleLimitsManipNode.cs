...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("scaleLimitsManip")]
    public sealed class MayaGenerated_ScaleLimitsManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (scaleLimitsManip)")]
