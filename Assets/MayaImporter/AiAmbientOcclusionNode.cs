...
namespace MayaImporter.Shaders
{
    ...
    [MayaNodeType("aiAmbientOcclusion")]
    public sealed class AiAmbientOcclusionNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (aiAmbientOcclusion)")]
