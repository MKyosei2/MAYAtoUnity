...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("shellTessellate")]
    public sealed class MayaGenerated_ShellTessellateNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (shellTessellate)")]
