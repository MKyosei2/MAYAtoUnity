...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyModifierManip")]
    public sealed class MayaGenerated_PolyModifierManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyModifierManip)")]
