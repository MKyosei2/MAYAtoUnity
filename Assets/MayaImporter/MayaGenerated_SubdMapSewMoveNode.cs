...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("subdMapSewMove")]
    public sealed class MayaGenerated_SubdMapSewMoveNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (subdMapSewMove)")]
