...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("cMuscleDisplay")]
    public sealed class MayaGenerated_CMuscleDisplayNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (cMuscleDisplay)")]
