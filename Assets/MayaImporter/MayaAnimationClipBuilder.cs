...
namespace MayaImporter.Animation
{
    public static class MayaAnimationClipBuilder
    {
        ...
        /// <summary>
        /// animCurveTL/TA/TU Q legacy AnimationClip 𐶐iV[ɑ݂ĂOj
        /// - TryGetAttr(protected) ͎gȂiReflectionőǂށj
        /// - ConnectionRole ɂ͈ˑȂ
        /// - Rootzɑ݂Transform path vZăoCh
        /// </summary>
