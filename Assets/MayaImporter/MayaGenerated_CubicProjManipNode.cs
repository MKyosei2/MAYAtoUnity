...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("cubicProjManip")]
    public sealed class MayaGenerated_CubicProjManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (cubicProjManip)")]
