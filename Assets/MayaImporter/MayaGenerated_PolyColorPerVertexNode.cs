...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyColorPerVertex")]
    public sealed class MayaGenerated_PolyColorPerVertexNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyColorPerVertex)")]
