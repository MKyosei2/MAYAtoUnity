...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("insertKnotSurface")]
    public sealed class MayaGenerated_InsertKnotSurfaceNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (insertKnotSurface)")]
