...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("ilrPointCloudShape")]
    public sealed class MayaGenerated_IlrPointCloudShapeNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (ilrPointCloudShape)")]
