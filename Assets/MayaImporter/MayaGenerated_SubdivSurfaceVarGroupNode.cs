...
// NodeType: subdivSurfaceVarGroup
...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("subdivSurfaceVarGroup")]
    public sealed class MayaGenerated_SubdivSurfaceVarGroupNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (subdivSurfaceVarGroup)")]
