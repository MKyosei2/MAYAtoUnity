...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("xgmModifierNoise")]
    public sealed class MayaGenerated_XgmModifierNoiseNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (xgmModifierNoise)")]
