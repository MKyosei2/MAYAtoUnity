...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("hwRenderGlobals")]
    public sealed class MayaGenerated_HwRenderGlobalsNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (hwRenderGlobals)")]
