...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("propMoveTriadManip")]
    public sealed class MayaGenerated_PropMoveTriadManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (propMoveTriadManip)")]
