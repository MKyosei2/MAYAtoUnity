...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("objectScriptFilter")]
    public sealed class MayaGenerated_ObjectScriptFilterNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (objectScriptFilter)")]
