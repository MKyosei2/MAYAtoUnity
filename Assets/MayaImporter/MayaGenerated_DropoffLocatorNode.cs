...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("dropoffLocator")]
    public sealed class MayaGenerated_DropoffLocatorNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (dropoffLocator)")]
