...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("planarProjManip")]
    public sealed class MayaGenerated_PlanarProjManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (planarProjManip)")]
