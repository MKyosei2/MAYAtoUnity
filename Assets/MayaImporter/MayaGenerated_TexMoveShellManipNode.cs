...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("texMoveShellManip")]
    public sealed class MayaGenerated_TexMoveShellManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (texMoveShellManip)")]
