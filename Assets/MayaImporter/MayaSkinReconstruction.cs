...
{
    /// <summary>
    /// SkinCluster  Unity  SkinnedMeshRenderer ֓KpB
    ///
    /// :
    /// - Unity1_4EFCg(BoneWeight){B
    /// - 𒴂EFCǵu킸vMayaSkinClusterComponent.FullWeights ɕێB
    /// - Unity͏4{̋ߎƂēKpiEĐړIjB
    /// </summary>
    public static class MayaSkinReconstruction
    {
        ...
        /// {헪:
        /// - Connections  mesh ۂm[hɒH
        /// - ꂪȂAKw/[g MayaMeshNodeComponent T
        /// </summary>
        public static GameObject FindTargetMeshForSkinCluster(MayaNodeComponentBase skinCluster)
        {
            ...
            if (skinCluster.Connections != null)
            {
                foreach (var c in skinCluster.Connections)
                {
                    ...
                    // outputGeometry / outputGeometry[0] Ƃ mesh ɌƂ
        ...
        /// <summary>
        /// MayaSkinClusterComponent  SkinnedMeshRenderer ɓKpB
        /// </summary>
