...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("timeSliderBookmark")]
    public sealed class MayaGenerated_TimeSliderBookmarkNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (timeSliderBookmark)")]
