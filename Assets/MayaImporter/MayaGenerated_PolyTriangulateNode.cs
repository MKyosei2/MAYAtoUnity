...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyTriangulate")]
    public sealed class MayaGenerated_PolyTriangulateNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyTriangulate)")]
