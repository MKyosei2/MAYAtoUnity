...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("keyframeRegionManip")]
    public sealed class MayaGenerated_KeyframeRegionManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (keyframeRegionManip)")]
