...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("animBlendNodeBoolean")]
    public sealed class MayaGenerated_AnimBlendNodeBooleanNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (animBlendNodeBoolean)")]
