...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("roundConstantRadius")]
    public sealed class MayaGenerated_RoundConstantRadiusNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (roundConstantRadius)")]
