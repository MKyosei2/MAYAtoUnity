...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("unknownTransform")]
    public sealed class MayaGenerated_UnknownTransformNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (unknownTransform)")]
