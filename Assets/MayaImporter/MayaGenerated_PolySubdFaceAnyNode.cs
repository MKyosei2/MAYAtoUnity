...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polySubdFaceAny")]
    public sealed class MayaGenerated_PolySubdFaceAnyNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polySubdFaceAny)")]
