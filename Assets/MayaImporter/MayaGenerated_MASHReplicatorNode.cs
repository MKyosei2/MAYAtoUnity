...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("MASH_Replicator")]
    public sealed class MayaGenerated_MASHReplicatorNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (MASH_Replicator)")]
