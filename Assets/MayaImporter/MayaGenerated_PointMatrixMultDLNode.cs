...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("pointMatrixMultDL")]
    public sealed class MayaGenerated_PointMatrixMultDLNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (pointMatrixMultDL)")]
