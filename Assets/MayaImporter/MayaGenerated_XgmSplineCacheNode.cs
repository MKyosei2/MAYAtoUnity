...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("xgmSplineCache")]
    public sealed class MayaGenerated_XgmSplineCacheNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (xgmSplineCache)")]
