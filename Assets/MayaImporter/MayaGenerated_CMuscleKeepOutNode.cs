...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("cMuscleKeepOut")]
    public sealed class MayaGenerated_CMuscleKeepOutNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (cMuscleKeepOut)")]
