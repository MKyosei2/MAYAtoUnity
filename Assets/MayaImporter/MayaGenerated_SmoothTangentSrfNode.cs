...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("smoothTangentSrf")]
    public sealed class MayaGenerated_SmoothTangentSrfNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (smoothTangentSrf)")]
