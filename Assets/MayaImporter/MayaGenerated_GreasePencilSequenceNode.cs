...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("greasePencilSequence")]
    public sealed class MayaGenerated_GreasePencilSequenceNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (greasePencilSequence)")]
