...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("deleteComponent")]
    public sealed class MayaGenerated_DeleteComponentNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (deleteComponent)")]
