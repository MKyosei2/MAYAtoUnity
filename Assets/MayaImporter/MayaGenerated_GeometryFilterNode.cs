...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("geometryFilter")]
    public sealed class MayaGenerated_GeometryFilterNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (geometryFilter)")]
