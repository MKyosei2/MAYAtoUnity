...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("FurCurveAttractors")]
    public sealed class MayaGenerated_FurCurveAttractorsNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (FurCurveAttractors)")]
