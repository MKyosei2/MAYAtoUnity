...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("pivotAndOrientManip")]
    public sealed class MayaGenerated_PivotAndOrientManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (pivotAndOrientManip)")]
