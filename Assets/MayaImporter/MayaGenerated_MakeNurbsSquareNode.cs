...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("makeNurbsSquare")]
    public sealed class MayaGenerated_MakeNurbsSquareNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (makeNurbsSquare)")]
