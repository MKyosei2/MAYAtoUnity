...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("hierarchyTestNode1")]
    public sealed class MayaGenerated_HierarchyTestNode1Node : MayaPhaseCNodeBase
    {
        [Header("Decoded (hierarchyTestNode1)")]
