...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("tangentConstraint")]
    public sealed class MayaGenerated_TangentConstraintNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (tangentConstraint)")]
