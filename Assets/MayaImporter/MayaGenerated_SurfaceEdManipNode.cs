...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("surfaceEdManip")]
    public sealed class MayaGenerated_SurfaceEdManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (surfaceEdManip)")]
