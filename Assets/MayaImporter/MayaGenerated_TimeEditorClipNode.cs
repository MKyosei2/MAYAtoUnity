...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("timeEditorClip")]
    public sealed class MayaGenerated_TimeEditorClipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (timeEditorClip)")]
