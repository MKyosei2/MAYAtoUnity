...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("contourProjManip")]
    public sealed class MayaGenerated_ContourProjManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (contourProjManip)")]
