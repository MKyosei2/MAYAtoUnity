...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("pointOnCurveManip")]
    public sealed class MayaGenerated_PointOnCurveManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (pointOnCurveManip)")]
