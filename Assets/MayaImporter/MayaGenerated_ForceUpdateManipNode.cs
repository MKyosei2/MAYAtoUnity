...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("forceUpdateManip")]
    public sealed class MayaGenerated_ForceUpdateManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (forceUpdateManip)")]
