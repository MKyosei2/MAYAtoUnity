...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("nurbsToSubdivProc")]
    public sealed class MayaGenerated_NurbsToSubdivProcNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (nurbsToSubdivProc)")]
