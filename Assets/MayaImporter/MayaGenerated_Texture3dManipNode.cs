...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("texture3dManip")]
    public sealed class MayaGenerated_Texture3dManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (texture3dManip)")]
