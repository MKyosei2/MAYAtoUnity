...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("Unfold3DUnfold")]
    public sealed class MayaGenerated_Unfold3DUnfoldNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (Unfold3DUnfold)")]
