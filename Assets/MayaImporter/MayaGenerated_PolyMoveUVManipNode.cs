...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyMoveUVManip")]
    public sealed class MayaGenerated_PolyMoveUVManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyMoveUVManip)")]
