...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("gameInputDevice")]
    public sealed class MayaGenerated_GameInputDeviceNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (gameInputDevice)")]
