...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("fltLightPointShape")]
    public sealed class MayaGenerated_FltLightPointShapeNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (fltLightPointShape)")]
