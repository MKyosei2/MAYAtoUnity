...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("reverseSurfaceManip")]
    public sealed class MayaGenerated_ReverseSurfaceManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (reverseSurfaceManip)")]
