...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("toggleOnLineManip")]
    public sealed class MayaGenerated_ToggleOnLineManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (toggleOnLineManip)")]
