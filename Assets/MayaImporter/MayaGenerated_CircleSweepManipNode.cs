...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("circleSweepManip")]
    public sealed class MayaGenerated_CircleSweepManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (circleSweepManip)")]
