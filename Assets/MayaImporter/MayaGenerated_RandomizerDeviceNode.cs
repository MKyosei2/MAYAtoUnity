...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("randomizerDevice")]
    public sealed class MayaGenerated_RandomizerDeviceNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (randomizerDevice)")]
