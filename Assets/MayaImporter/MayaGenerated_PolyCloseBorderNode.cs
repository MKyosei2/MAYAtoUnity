...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("polyCloseBorder")]
    public sealed class MayaGenerated_PolyCloseBorderNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (polyCloseBorder)")]
