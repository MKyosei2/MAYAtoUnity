...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("xgmGuideSculptManip")]
    public sealed class MayaGenerated_XgmGuideSculptManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (xgmGuideSculptManip)")]
