...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("jointTranslateManip")]
    public sealed class MayaGenerated_JointTranslateManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (jointTranslateManip)")]
