...
// ★名前衝突回避（MayaImporter が型として存在しても必ず namespace を指す）
...
namespace MayaImporter.DAG
{
    ...
    public sealed class TransformNode : MayaNodeComponentBase
    {
        public override void ApplyToUnity(MayaImportOptions options, MayaImportLog log)
        {
            ...
            // TRS-only audit matrices（rotateOrder は applier 側が扱うのでここは概算）
            ...
            // rotateOrder を確実に反映（euler は Maya 空間値を保持し、applier 側で変換）
