...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("hairConstraint")]
    public sealed class MayaGenerated_HairConstraintNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (hairConstraint)")]
