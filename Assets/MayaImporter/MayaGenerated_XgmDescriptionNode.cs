...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("xgmDescription")]
    public sealed class MayaGenerated_XgmDescriptionNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (xgmDescription)")]
