...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("oldNormalConstraint")]
    public sealed class MayaGenerated_OldNormalConstraintNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (oldNormalConstraint)")]
