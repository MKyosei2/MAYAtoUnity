...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("defaultRenderingList")]
    public sealed class MayaGenerated_DefaultRenderingListNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (defaultRenderingList)")]
