...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("textureDeformer")]
    public sealed class MayaGenerated_TextureDeformerNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (textureDeformer)")]
