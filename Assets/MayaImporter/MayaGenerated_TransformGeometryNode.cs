...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("transformGeometry")]
    public sealed class MayaGenerated_TransformGeometryNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (transformGeometry)")]
