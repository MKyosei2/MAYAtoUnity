...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("ilrBakeLayerManager")]
    public sealed class MayaGenerated_IlrBakeLayerManagerNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (ilrBakeLayerManager)")]
