...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("timeEditorTracks")]
    public sealed class MayaGenerated_TimeEditorTracksNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (timeEditorTracks)")]
