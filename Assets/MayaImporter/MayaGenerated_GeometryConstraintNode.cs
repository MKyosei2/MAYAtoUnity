...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("geometryConstraint")]
    public sealed class MayaGenerated_GeometryConstraintNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (geometryConstraint)")]
