...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("projectionUVManip")]
    public sealed class MayaGenerated_ProjectionUVManipNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (projectionUVManip)")]
