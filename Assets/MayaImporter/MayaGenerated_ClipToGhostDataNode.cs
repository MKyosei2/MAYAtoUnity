...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("clipToGhostData")]
    public sealed class MayaGenerated_ClipToGhostDataNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (clipToGhostData)")]
