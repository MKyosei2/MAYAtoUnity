...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("paramDimension")]
    public sealed class MayaGenerated_ParamDimensionNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (paramDimension)")]
