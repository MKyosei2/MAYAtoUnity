...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("offsetDeformer")]
    public sealed class MayaGenerated_OffsetDeformerNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (offsetDeformer)")]
