...
namespace MayaImporter.Generated
{
    ...
    [MayaNodeType("postProcessList")]
    public sealed class MayaGenerated_PostProcessListNode : MayaPhaseCNodeBase
    {
        [Header("Decoded (postProcessList)")]
